...
export const menuCategories = [
  ...
  },
  {
    ...
    title: "ראמן",
    footnote:
      "הראמן שלנו הוא בסגנון צ׳ינטן (清湯 – Chintan) – ציר עדין וצלול, המבושל על להבה נמוכה לאורך זמן כדי להוציא את מלוא הטעמים מהמרכיבים הטריים. הסגנון הזה מעניק קערת ראמן קלילה ומאוזנת עם עומק טעמים עשיר אך לא כבד",
    items: [
      {
        name: "ראמן חזיר",
